function createYellowStall(scene, THREE) {
    const stallInfo = { x: 10, z: -10, color: 0xffff00, music: 'https://file.garden/Zy7B0LkdIVpGyzA1/music4.mp3' };
    ...
    // Create a counter
    const counterGeometry = new THREE.BoxGeometry(4.5, 1, 0.75);
    ...
    stallGroup.userData.lazyLoadWallTexture = async () => {
        try {
            ...
            xWall1.material.map = wallTexture;
            xWall2.material.map = wallTexture;
            zWall1.material.map = wallTexture;
            zWall2.material.map = wallTexture;

            // Force material update
            stall.material.needsUpdate = true;
            xWall1.material.needsUpdate = true;
            xWall2.material.needsUpdate = true;
            zWall1.material.needsUpdate = true;
            zWall2.material.needsUpdate = true;
